	...
	<div class="row">
		<div class="eight columns">
			...
			<div class="row">
				<div class="twelve columns">
					<div>
						<p>This paragraph is optional, and will be shown above the listing of News posts. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="twelve columns">
          <a href="news_page.php"><h4>News Item Title</h4></a>
					<div class="panel">
            <p>October 31, 2012</p>
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
					</div>
      ...
      <ul class="pagination offset-by-three">
		...
		<div class="four columns">
			<h4>News Archive</h4>
			<p>Find past articles in the archive below:</p>

			<ul class="square">
				<li><a href="#">November (1)</a></li>
				<li><a href="#">October (4)</a></li>
